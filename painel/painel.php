<?php
    ...
    $sql = "SELECT * FROM TB_CADASTRO_USUARIO WHERE ATIVO = 'SIM' ORDER BY ID_USUARIO ASC";
...
<body class="bg-dark h-100">
            ...
            <div class="row">
                ...
                <div class="col dropdown d-flex align-items-center justify-content-end">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item text-end" href="../painel/recuperar-senha.html">
                                <small>Alterar Senha</small>
                            </a>
                            <a class="dropdown-item text-end" href="../painel/login.html">
                                <small>Sair</small>
                            </a>
                        </li>
                    </ul>
    ...
    <div class="d-flex" style="min-height: calc(100vh - 76px - 72px);">
        <aside class="bg-custom text-light py-4" style="width: 250px;">
            <div class="menu">
                <div class="item">
                    ...
                    <div class="collapse show" id="menu-usuario">
                        <div class="bg-dark d-flex flex-column rounded mx-4 p-2 row-gap-1">
                            ...
                            <a href="../painel/painel.php" class="submenu-link link-light text-decoration-none rounded p-2 active">
                                <small class="d-flex justify-content-between align-items-center">
                                    Listagem
                ...
                <a href="../painel/painel.php" class="w-100 d-flex align-items-center gap-2 link-light text-decoration-none mt-2 py-3 px-3 ms-1 icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(-.125rem, 0, 0);">
        ...
        <main class="col h-100 text-light p-4">
            <div class="d-flex justify-content-between mb-4">
                ...
                <div class="d-flex gap-2">
                    <a href="../dompdf/gerar_pdf.php" class="btn btn-light" title="PDF">
                    ...
                    <a href="../painel/gerar_excel.php" class="btn btn-light" title="Excel">
                    ...
                    <a href="../painel/cadastrar.php" class="btn btn-light">+ Cadastrar Usuário</a>
                </div>
            </div>
                ...
                <form action="" class="bg-custom rounded col-12 py-3 px-4">
                    ...
                    <div class="row align-items-end row-gap-4">
                        <div class="col-3 d-flex flex-wrap">
                            <label for="pesquisar" class="col-form-label">Buscar:</label>
                            <div class="col-12">
                                <input type="text" class="form-control bg-dark text-light border-dark" id="pesquisar" placeholder="Ex: Admin">
                            </div>
                        </div>
                                    ...
                                    <?php
                                        while($user_data = mysqli_fetch_assoc($result))
                                        {
                                            ...
                                            echo "<td>
                                                ...
                                                <a href='../painel/editar.php' class='btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2' title='Editar'>
                                                ...
                                                <a class='btn btn-sm btn-danger' href='../painel/backend/delete.php?id=$user_data[ID_USUARIO]' title='Deletar'>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" id="$user_data['ID_USUARIO']">
