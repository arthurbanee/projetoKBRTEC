                ...
                <div class="col dropdown d-flex align-items-center justify-content-end">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            ...
                            <a class="dropdown-item text-end" href="../painel/painel.php">
                                <small>Sair</small>
                            </a>
                        </li>
                    </ul>
    ...
    <div class="d-flex" style="min-height: calc(100vh - 76px - 72px);">
                ...
                <div class="item">
                    ...
                    <div class="collapse show" id="menu-usuario">
                        <div class="bg-dark d-flex flex-column rounded mx-4 p-2 row-gap-1">
                            <a href="../painel/cadastrar.php" class="submenu-link link-light text-decoration-none rounded p-2">
                                <small class="d-flex justify-content-between align-items-center">
                                    Cadastrar
                                </small>
                            </a>
                            <a href="../painel/painel.php" class="submenu-link link-light text-decoration-none rounded p-2">
                                <small class="d-flex justify-content-between align-items-center">
                                    Listagem
                                </small>
                            </a>
        ...
        <main class="col h-100 text-light p-4">
            <div class="d-flex align-items-end justify-content-between mb-4">
                ...
                <a href="../painel/painel.php" class="btn btn-light">Voltar</a>
            </div> 

<form action="../painel/editar_usuario.php" method="post" class="bg-custom rounded col-12 py-3 px-4">
    <input type="hidden" name="ID_USUARIO" value="<?php echo $linhas['ID_USUARIO']; ?>">

    <div class="mb-3 row">
        <label for="usuario" class="col-sm-2 col-form-label">Usuário:</label>
        <div class="col-sm-10">
            <input type="text" name="USUARIO" class="form-control bg-dark text-light border-dark" id="usuario" placeholder="Ex: Admin" value="<?php echo $linhas['USUARIO']; ?>">
        </div>
    </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <input type="email" name="EMAIL" class="form-control bg-dark text-light border-dark" id="email" placeholder="Ex: admin@kbrtec.com.br" value="<?php echo $linhas['EMAIL']; ?>">
        </div>
    </div>
